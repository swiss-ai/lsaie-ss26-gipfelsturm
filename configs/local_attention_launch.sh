...
if [ -n "$WANDB_API_KEY" ]; then
    ...
    TRAINING_CMD="$TRAINING_CMD \
        ...
        --wandb-exp-name $EXP_NAME-local_attention-$SLURM_JOB_ID"
else
...
SCRIPT="logs/${JOB_NAME}-local_attention.sbatch"
...
#SBATCH --output=logs/%x-local_attention-%j.log
#SBATCH --error=logs/%x-local_attention-%j.log
#SBATCH --nodes=${NODES}
