...
if [ -n "$WANDB_API_KEY" ]; then
    ...
    TRAINING_CMD="$TRAINING_CMD \
        ...
        --wandb-exp-name $EXP_NAME-fused_attention-$SLURM_JOB_ID"
else
...
SCRIPT="logs/${JOB_NAME}-fused_attention.sbatch"
...
#SBATCH --output=logs/%x-fused_attention-%j.log
#SBATCH --error=logs/%x-fused_attention-%j.log
#SBATCH --nodes=${NODES}
