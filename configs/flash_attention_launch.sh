...
if [ -n "$WANDB_API_KEY" ]; then
    ...
    TRAINING_CMD="$TRAINING_CMD \
        ...
        --wandb-exp-name $EXP_NAME-flash_attention-$SLURM_JOB_ID"
else
...
SCRIPT="logs/${JOB_NAME}-flash_attention.sbatch"
...
#SBATCH --output=logs/%x-flash_attention-%j.log
#SBATCH --error=logs/%x-flash_attention-%j.log
#SBATCH --nodes=${NODES}
